...
process.env.BUILD_ENV = process.env.REACR_APP_SECRET_API || 'dev'
...
const uploadOSSConfig=require('./uploadconfig')
...
function build(previousFileSizes) {
  console.log(`Creating an optimized ${process.env.BUILD_ENV} build...`);
